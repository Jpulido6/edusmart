...
export const ClasesPage = lazy(() => import('../pages/private/clases/presentation/Clases'));
export const AlumnosPage = lazy(() => import('../pages/private/alumnos/presentation/AlumnosPage'));
export const CalendarioPage = lazy(() => import('../pages/private/calendar/presentation/Calendario'));
export const CalificacionesPage = lazy(() => import('../pages/private/calificaciones/presentation/Calificaciones'));
export const ReportesPage = lazy(() => import('../pages/private/reportes/presentation/Reportes'));